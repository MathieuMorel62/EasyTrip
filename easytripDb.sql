...
CREATE TABLE `hotels` (
  ...
  PRIMARY KEY (`id`),
  KEY `tripId` (`tripId`),
  CONSTRAINT `hotels_ibfk_1` FOREIGN KEY (`tripId`) REFERENCES `trips` (`id`)
...
CREATE TABLE `itinerary` (
  ...
  PRIMARY KEY (`id`),
  KEY `tripId` (`tripId`),
  CONSTRAINT `itinerary_ibfk_1` FOREIGN KEY (`tripId`) REFERENCES `trips` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `locations` (
  ...
  PRIMARY KEY (`id`),
  KEY `tripId` (`tripId`),
  CONSTRAINT `locations_ibfk_1` FOREIGN KEY (`tripId`) REFERENCES `trips` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `trips` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
  CONSTRAINT `trips_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-09-08 13:31:49
